...
======================================================================
Adaptação do DoclingWorkerTask original para herdar de BaseTask em vez de QThread.
A lógica de conversão Docling é preservada, mas o mecanismo de execução
